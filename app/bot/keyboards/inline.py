...
def get_cornice_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="ПК-14 (3.2 м) — 12300 ₽", callback_data="cornice_pk14_3_2m"
                )
            ],
            [
                InlineKeyboardButton(
                    text="ПК-14 (3.6 м) — 13838 ₽", callback_data="cornice_pk14_3_6m"
                )
            ],
            [
                InlineKeyboardButton(
                    text="ПК-5 (цена за пог.м) — 2819 ₽/пог.м", callback_data="cornice_pk5"
                )
            ],
            [
                InlineKeyboardButton(
                    text="БП-40 (цена за пог.м) — 1282 ₽/пог.м", callback_data="cornice_bp40"
                )
            ],
        ]
    )
